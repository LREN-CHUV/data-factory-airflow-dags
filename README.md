...
* In Airflow config file, add a [data-factory] section with the following entries:
    ...
    * DATA_CATALOG_DB_SQL_ALCHEMY_CONN: connection URL to the Data catalog database tracking artifacts generated by the MRI pipelines.
    * I2B2_DB_SQL_ALCHEMY_CONN: connection URL to the I2B2 database storing all the MRI pipelines results.
