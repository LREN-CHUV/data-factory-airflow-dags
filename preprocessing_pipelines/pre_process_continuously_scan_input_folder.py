...
def pre_process_continuously_scan_input_folder_dag(dataset, folder, email_errors_to, trigger_dag_id):
    ...
    dag_name = '%s_pre_process_continuously_scan_input_folder' % dataset.lower().replace(" ", "_")
